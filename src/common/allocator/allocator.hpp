...
#ifndef __CHAMELEON_ALLOCATOR_ALLOCATOR_HPP__
#define __CHAMELEON_ALLOCATOR_ALLOCATOR_HPP__
...
#include <common/maintenance/maintenance.hpp>

#include <common/quota/quota.hpp>
