...
#ifndef __CHAMELEON_SLAVE_ISOLATOR_HPP__
#define __CHAMELEON_SLAVE_ISOLATOR_HPP__
...
#include <common/slave/containerizer.hpp>
...
#endif // __CHAMELEON_SLAVE_ISOLATOR_HPP__
