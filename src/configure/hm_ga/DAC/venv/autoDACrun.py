...
def makeConfig():
   ...
   #                                   "org.apache.spark.serializer.KryoSerializer"])
    ...
    confFile = open("/home/zyx/CLionProjects/spark-2.3.0/conf/spark-defaults.conf", "w")
...
def runJob():
    ...
    # run job
    command = "/home/zyx/app/Hibench-7.0/bin/workloads/micro/wordcount/spark/run.sh"
...
def makeResult(total):
    ...
    benFile = open("/home/zyx/app/Hibench-7.0/report/hibench.report","r")
    ...
    confVec = []
    confVecFile = open("/home/zyx/app/Hibench-7.0/report/confVec.txt","r")
    for i in range(total):
    ...
    comVecFile = open("/home/zyx/app/Hibench-7.0/report/time_conf.txt","w")
    comVec = []
    for i in range(total):
        tmpVec = []
        tailVec = []
...
def main():
    ...
    cmdrm = "rm -rf /home/zyx/app/Hibench-7.0/report/hibench.report"
    cmdtouch = "touch /home/zyx/app/Hibench-7.0/report/hibench.report"
    os.system(cmdrm)
    os.system(cmdtouch)

    firstline = "Type         Date       Time     Input_data_size      Duration(s)"+\
                "          Throughput(bytes/s)  Throughput/node\n"
    firFile = open("/home/zyx/app/Hibench-7.0/report/hibench.report","w")
    firFile.write(firstline)
    firFile.close()
    
    # clear error log folder:errorDAC
    cmdrmlog = "rm -rf /home/zyx/app/Hibench-7.0/report/errorDAC/*"
    os.system(cmdrmlog)
    ...
    for i in range(total):
        ...
        if res == 0:
            ...
            confVecFile = open("/home/zyx/app/Hibench-7.0/report/confVec.txt", "a")
            # confVecFile = open("./confVec.txt", "w")
            ...
            # save error log
            cmdlog = "cp /home/zyx/app/Hibench-7.0/report/terasort/spark/bench.log" + \
                     " /home/zyx/app/Hibench-7.0/report/errorDAC/" + str(i) + "error.log"
            os.system(cmdlog)
            ...
            errorVecFile = open("/home/zyx/app/Hibench-7.0/report/err_timeConfVec.txt", "a")
