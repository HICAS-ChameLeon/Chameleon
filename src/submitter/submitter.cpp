...
//The following flags has default value
DEFINE_int32(port, 6062, "port");

//The following flags must be set by user
DEFINE_string(master, "", "ip and port info");
...
static const bool path_Str = gflags::RegisterFlagValidator(&FLAGS_path, &ValidateStr);
